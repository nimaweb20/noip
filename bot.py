...
bot = Bot("lpjivsohibvizmltbgvlqjjltkujpaty")
target = "g0CSM1x000e96eb6a6baffd9a1107e8e"
					...
					if msg["type"]=="Text" and not msg["message_id"] in answered:
						...
						if msg["author_object_guid"] in admins:
							...
							if msg["text"] == "ربات خاموش" or msg["text"] == "/sleep" :
								...
								bot.sendMessage(target, "سلام دوست عزیز برای آشنایی با دستورات بنویس \n دستورات", msg["message_id"])
